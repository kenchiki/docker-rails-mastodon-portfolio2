...
document.addEventListener('turbolinks:load', function () {
  ...
  function check_to_hide_or_show_add_link() {
    if ($('#categories .nested-fields').length == 5) {
      $('#add-category a').hide();
    } else {
      $('#add-category a').show();
    }
  ...
  $(jsWorkImages).on('cocoon:after-insert cocoon:after-remove', function () {
...
/******/ });
//# sourceMappingURL=application-482e225a25ce6a38b2f8.js.map